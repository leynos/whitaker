...
impl PredicateWorld {
    fn set_limit(&self, value: usize) { self.limit.set(value); }

    fn set_branches(&self, value: usize) { self.branches.set(value); }
...
fn given_limit(world: &PredicateWorld, limit: usize) { world.set_limit(limit); }

#[given("the predicate declares {branches} branches")]
fn given_branches(world: &PredicateWorld, branches: usize) { world.set_branches(branches); }

#[when("I evaluate the predicate complexity")]
fn when_evaluate(world: &PredicateWorld) { world.evaluate(); }
