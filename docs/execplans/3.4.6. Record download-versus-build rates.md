...
- [ ] Finalize metric model and persistence format.
- [ ] Implement instrumentation in installer orchestration.
- [ ] Add unit coverage.
- [ ] Add `rstest-bdd` behaviour coverage.
- [ ] Update design docs and roadmap.
- [ ] Run quality gates and capture evidence.
...
- Decision: Define rates over successful completed installs only.
  ...
  observed end-user outcomes. Date/Author: 2026-02-21 (agent, draft).
...
- Decision: Treat metrics read/write failures as non-fatal warnings.
  ...
  telemetry completeness. Date/Author: 2026-02-21 (agent, draft).

## Outcomes & retrospective

Pending implementation.

Success target at completion:

- Installer records and reports download/build rates plus total install time.
- Unit and BDD tests cover happy/unhappy/edge paths.
- Docs and roadmap are updated and quality gates pass.
...
Revision note (2026-02-21): Initial draft created for roadmap item 3.4.6.
