...
- `new() -> Self` — empty set.
- `record_reference` accepts a path and expansion flag:

      record_reference(&mut self, path: impl Into<String>, is_from_expansion: bool)

  It inserts path unless `is_from_expansion` is true.
